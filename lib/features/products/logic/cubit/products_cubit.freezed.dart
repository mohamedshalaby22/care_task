...
mixin _$ProductsState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<ProductListResponse> products) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<ProductListResponse> products)? success,
...
abstract class _$$SuccessImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({List<ProductListResponse> products});
}
...
class _$SuccessImpl<T> implements Success<T> {
  const _$SuccessImpl(final List<ProductListResponse> products)
      : _products = products;

  final List<ProductListResponse> _products;
  @override
  List<ProductListResponse> get products {
  ...
  @override
  String toString() {
    return 'ProductsState<$T>.success(products: $products)';
  }
...
abstract class Success<T> implements ProductsState<T> {
  const factory Success(final List<ProductListResponse> products) =
      _$SuccessImpl<T>;
